...
import { ChromeDebuggerSession } from "@shuvgeist/driver/cdp-session";
...
export const debuggerSchema = Type.Object({
...
export const DEBUGGER_TOOL_DESCRIPTION = `Execute JavaScript in the MAIN world or access browser APIs that browserjs() and repl tool cannot.
