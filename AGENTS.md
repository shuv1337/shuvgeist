...
This project is indexed by GitNexus as **shuvgeist** (7201 symbols, 16183 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
