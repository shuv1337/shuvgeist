...
export const TTS_SETTINGS_KEYS = {
	...
	readAlongEnabled: "tts.readAlongEnabled",
...
export function normalizeTtsSettings(raw: Partial<Record<string, unknown>> = {}): TtsSettingsSnapshot {
	...
	const snapshot: TtsSettingsSnapshot = {
		...
		readAlongEnabled: normalizeBoolean(
			raw[TTS_SETTINGS_KEYS.readAlongEnabled],
			DEFAULT_TTS_SETTINGS.readAlongEnabled,
		),
	...
	await Promise.all(
		(
			[
				...
				[TTS_SETTINGS_KEYS.readAlongEnabled, next.readAlongEnabled],
