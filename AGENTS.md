...
This project is indexed by GitNexus as **shuvgeist** (5551 symbols, 10873 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
