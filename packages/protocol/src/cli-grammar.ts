...
export const CliFlagDefinitions = [
	...
	{ names: ["--audio"], key: "audio", kind: "boolean" },
	...
	{ names: ["--method"], key: "method", kind: "string" },
	{ names: ["--body"], key: "body", kind: "string" },
	{ names: ["--schema"], key: "schema", kind: "string" },
	{ names: ["--max-response-bytes"], key: "maxResponseBytes", kind: "string" },
	...
	{ names: ["--mode"], key: "recordingMode", kind: "string" },
