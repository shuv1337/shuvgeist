...
This project is indexed by GitNexus as **shuvgeist** (6344 symbols, 14523 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
