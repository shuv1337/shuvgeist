...
import { type BridgeSkillSnapshotStatus, createBridgeSkillSnapshot } from "@shuvgeist/protocol/skill-snapshot";
import { html } from "lit";
import type { BridgeSettings } from "../bridge/internal-messages.js";
...
export class SkillsTab extends SettingsTab {
	...
	async exportSkills() {
		...
		a.href = url;
		a.download = `shuvgeist-skills-${new Date().toISOString().split("T")[0]}.json`;
		a.click();
