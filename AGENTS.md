...
This project is indexed by GitNexus as **shuvgeist** (7622 symbols, 17234 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
