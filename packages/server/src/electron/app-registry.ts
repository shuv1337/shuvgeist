/** Electron application registry owned by the server package. */
...
export const KNOWN_ELECTRON_APPS: ElectronApp[] = [
	...
	},
	{
		...
		notes: "The Linux launcher manages Codex Desktop startup; attaching to an already running CDP endpoint is usually more reliable than launching a second instance.",
	},
	{
