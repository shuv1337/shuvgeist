import { getBridgeCommandMetadata, isCatalogTargetDispatchedMethod } from "@shuvgeist/protocol/command-catalog";
import { type BridgeError, type BridgeMethod, ErrorCodes } from "@shuvgeist/protocol/protocol";
import { type BridgeTarget, isChromeTarget, isElectronTarget, targetTeachingLabel } from "@shuvgeist/protocol/target";
